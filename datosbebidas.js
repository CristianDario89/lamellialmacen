...
var todos = [ {
    id:"",
    secciones:["cervezas","vinos","jugos","otrasbeb"],
    descripcion: "",
...
over1("#pb5", jugos[4].marca,jugos[4].precio,jugos[4].img);
over1("#pb6", jugos[5].marca,jugos[5].precio,jugos[5].img);
over1("#pb7", jugos[6].marca,jugos[6].precio,jugos[6].img);
