...
/*-------------------------LIMPIEZA--------LIMPIEZA------------*/
var articulos = [ {
   marca: "ayudin lavandina",
    precio: 70,
     img:"images/limpi/l1.jpg"
},
{
    marca: "ala detergente",
     precio: 75,
...
var higiene = [ {
    marca: " shampoo plusbelle",
    precio: 160,
    img:"images/limpi/l5.jpg"
},
{
    marca: "raid matacucarachas y mosquitos",
   precio: 280,
    img:"images/limpi/z2.jpg" 
},
{
    marca: "magistral detergente",
     precio: 100,
...
{
    marca: "cofler aireado 55g",
    descripcion: "blanco / negro",
    precio: 115,
    img:"images/golo/ch2.jpg" 
},
{
   marca: "milka leger leche",
  precio: 70,
...
over1("#pbj2", jugos[1].marca,jugos[1].precio,jugos[1].img);
...
over1("#pb1", cervezas[0].marca,cervezas[0].precio,cervezas[0].img);
over1("#pb2", cervezas[1].marca,cervezas[1].precio,cervezas[1].img);
...
over1("#pg15", alfajores[4].marca,alfajores[4].precio,alfajores[4].img);
over1("#pg16", alfajores[5].marca,alfajores[5].precio,alfajores[5].img); 
...
over1("#pc1", ciga1[0].marca,ciga1[0].precio,ciga1[0].img);
over1("#pc2", ciga1[1].marca,ciga1[1].precio,ciga1[1].img);
over1("#pc3", ciga1[2].marca,ciga1[2].precio,ciga1[2].img);
over1("#pc4", ciga1[3].marca,ciga1[3].precio,ciga1[3].img);
over1("#pc5", ciga1[4].marca,ciga1[4].precio,ciga1[4].img);
